            ...
            <div class="login-right">
                <Transition :name="stepDirection === 'forward' ? 'step-slide-forward' : 'step-slide-backward'"
                    ...
                    <div v-if="step === 'username'" class="step-container" key="username">
                        ...
                        <el-form ref="usernameFormRef" :model="formData" :rules="usernameRules" label-position="top">
                            <el-form-item prop="username">
                                <el-input v-model="formData.username" placeholder="用户名" @keyup.enter="goToPassword"
                                    autocomplete="off" autofocus />
                            </el-form-item>
                        </el-form>

                        <div v-if="usernameCheckResult" class="status-tip"
                    ...
                    <div v-else-if="step === 'password'" class="step-container" key="password">
                        ...
                        <el-form ref="passwordFormRef" :model="formData" :rules="passwordRules" label-position="top">
                            <el-form-item prop="password">
                                <el-input v-model="formData.password" type="password" placeholder="输入密码" show-password
                                    @keyup.enter="goToPasswordConfirm" autocomplete="new-password" autofocus />
                            </el-form-item>
                        </el-form>
                        ...
                        <div class="step-actions">
                            ...
                            <el-button class="next-btn" @click="goToPasswordConfirm">
                                下一步
                            </el-button>
                        </div>
                    </div>
                    ...
                    <!-- 第三步：确认密码 -->
                    <div v-else-if="step === 'password-confirm'" class="step-container" key="password-confirm">
                        <h2 class="step-title">确认密码</h2>
                        <p class="step-subtitle">请再次输入密码以确认</p>

                        <el-form ref="passwordConfirmFormRef" :model="formData" :rules="passwordConfirmRules"
                            label-position="top">
                            <el-form-item prop="passwordConfirm">
                                <el-input v-model="formData.passwordConfirm" type="password" placeholder="再次输入密码"
                                    show-password @keyup.enter="goToEmail" autocomplete="new-password" autofocus />
                            </el-form-item>
                        </el-form>

                        <div class="step-actions">
                            <el-button class="back-btn" @click="backToPassword">返回</el-button>
                            <el-button class="next-btn" @click="goToEmail">
                                下一步
                            </el-button>
                        </div>
                    </div>
                    ...
                    <div v-else-if="step === 'email'" class="step-container" key="email">
                        ...
                        <el-form ref="emailFormRef" :model="formData" :rules="emailRules" label-position="top">
                            <el-form-item prop="email">
                                <el-input v-model="formData.email" type="email" placeholder="邮箱地址"
                                    @keyup.enter="handleSendCode" autocomplete="email" autofocus />
                            </el-form-item>
                        </el-form>
                    ...
                    <div v-else-if="step === 'code'" class="step-container" key="code">
                        ...
                        <el-form ref="codeFormRef" :model="formData" :rules="codeRules" label-position="top">
                            <el-form-item prop="code">
                                <el-input v-model="formData.code" placeholder="输入6位验证码" maxlength="6"
                                    @input="formData.code = formData.code.replace(/[^\d]/g, '')"
                                    @keyup.enter="handleRegister" autofocus />
                            </el-form-item>
                        </el-form>
