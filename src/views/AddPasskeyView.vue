                    ...
                    <div v-else-if="step === 'name-input'" class="step-container" key="name-input">
                        ...
                        <el-form ref="nameFormRef" :model="passkeyInput" :rules="nameRules" label-position="top">
                            <el-form-item prop="name">
                                <el-input v-model="passkeyInput.name" placeholder="例如：我的 MacBook Pro" maxlength="50"
                                    show-word-limit @keyup.enter="handleSubmit" autofocus />
                            </el-form-item>
                        </el-form>
...
const handleCreateCredential = async () => {
    ...
    try {
        ...
        // 1. 获取注册选项（先用空名称）
        const options = await getPasskeyRegistrationOptions({ passkeyName: 'temp' })
